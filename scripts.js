...
// for (let i = 0;  i <br arr5.length;  i++) {
//     if (i > 4) {
...
// while (a8 >= 0) {
//     rez.push(arr8[a8]).toString().split('').reverse().join('')
//     a8--;
// }
...
// for (; a9 < arr9.length; a9++) {
//     if (arr9[a9] === undefined) {
//         counter++;
//     }
// }
...
for (let i=1; i < a11; i++) {
    document.write ('<pre>' + ' '.repeat(a11 - i) + '^'.repeat(i * 2 - 1) + ' '.repeat(a11 - i) + '</pre>');
}